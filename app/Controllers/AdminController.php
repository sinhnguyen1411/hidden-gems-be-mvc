...
class AdminController
{
    public function dashboard(Request $req): Response
    {
        ...
        return (new Response())->json(['data'=>compact('users','shops','stores','reviews','vouchers','promos')]);
    }
    ...
    public function setRole(Request $req): Response
    {
        ...
        return (new Response())->json(['message'=>'Role updated']);
    }
    ...
    public function pendingStores(Request $req): Response
    {
        ...
        $stmt->execute();
        return (new Response())->json(['data'=>$stmt->fetchAll()]);
    }
    ...
    public function approveStore(Request $req): Response
    {
        ...
        $st = $stmt->fetch();
        if (!$st) return (new Response())->json(['error'=>'Status not configured'],500);
